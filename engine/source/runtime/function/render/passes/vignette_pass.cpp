...
namespace Piccolo
{
    ...
    void VignettePass::setupDescriptorSetLayout()
    {
        ...
        post_process_global_layout_create_info.bindingCount = 1;
        post_process_global_layout_create_info.pBindings = &post_process_global_layout_input_attachment_binding;
    ...
    void VignettePass::setupPipelines()
    {
        ...
        pipeline_info.subpass             = _main_camera_subpass_vignette;
